...
const getUserWithId = async (req, res) => {
    try {
        ...
        res.status(StatusCode.INTERNAL_SERVER_ERROR).send({ message: 'Error occured while trying to retrive user with ID: ' + req.params.userId, error: error.message})
    }
}
...
const getUserWithUsernameQuery = async (req, res) => {
    try {
        ...
        res.status(StatusCode.INTERNAL_SERVER_ERROR).send({
            message: 'Error occured while trying to retrive user with username: ' + req.query.userId,
            error: error.message
        })
